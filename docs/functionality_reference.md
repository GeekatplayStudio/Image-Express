...
Broader current-state product baseline:
- `docs/current_application_baseline_audit_2026-05-16.md`

Scope note:
- this file remains focused on editor and properties QA preservation,
- use the baseline audit for full application feature coverage, workflow mapping, roadmap reconciliation, and priority planning.
