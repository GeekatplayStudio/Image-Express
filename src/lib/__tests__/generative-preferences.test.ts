...
describe('generative-preferences', () => {
    ...
    it('saves and dispatches updates', () => {
        ...
        const next = saveGenerativePreferences({
            ...
            comfyTunnelUrl: 'https://comfy.tailnet.ts.net',
    ...
    it('persists the explicit tunnel connection mode', () => {
        const next = saveGenerativePreferences({
            comfyConnectionMode: 'tunnel',
            comfyTunnelUrl: 'https://comfy.tailnet.ts.net',
        });

        expect(next.comfyConnectionMode).toBe('tunnel');
        expect(loadGenerativePreferences().comfyConnectionMode).toBe('tunnel');
    });
