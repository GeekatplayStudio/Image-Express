...
const ADMIN_DEFAULT_EMAIL = normalizeEmail(process.env.IMAGE_EXPRESS_ADMIN_EMAIL || 'geekatplay@gmail.com');
const ADMIN_DEFAULT_USERNAME = (process.env.IMAGE_EXPRESS_ADMIN_USERNAME || 'vovka').trim();
const ADMIN_DEFAULT_PASSWORD = process.env.IMAGE_EXPRESS_ADMIN_PASSWORD || 'vovka';
const DEFAULT_MEMBER_EMAIL = normalizeEmail(process.env.IMAGE_EXPRESS_DEFAULT_USER_EMAIL || 'iam@geekatplay.com');
const DEFAULT_MEMBER_USERNAME = (process.env.IMAGE_EXPRESS_DEFAULT_USER_USERNAME || 'iam').trim();
const DEFAULT_MEMBER_PASSWORD = process.env.IMAGE_EXPRESS_DEFAULT_USER_PASSWORD || 'vovka3792!';
const DEFAULT_MEMBER_DISPLAY_NAME = (process.env.IMAGE_EXPRESS_DEFAULT_USER_DISPLAY_NAME || 'iam').trim();
...
async function ensureSeedUsers(store: UserStore) {
    ...
    const memberIndex = users.findIndex((user) => user.email === DEFAULT_MEMBER_EMAIL);
    if (memberIndex < 0) {
