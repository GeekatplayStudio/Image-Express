...
export const stampDodge = ({
    ...
    // Burn multiplies the destination, so it needs a dark stamp; dodge/sponge stamp white.
    const channel = compositeOperation === 'multiply' ? 0 : 255;
    gradient.addColorStop(0, `rgba(${channel},${channel},${channel},${coreOpacity})`);
    gradient.addColorStop(1, `rgba(${channel},${channel},${channel},${edgeOpacity})`);
