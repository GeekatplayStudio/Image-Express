...
describe('TopToolOptionsBar', () => {
    ...
    it('renders and wires paint family controls', () => {
        ...
        fireEvent.change(screen.getByLabelText('Paint preset'), { target: { value: 'marker' } });
        expect(onPaintPresetChange).toHaveBeenCalledWith('marker');

        fireEvent.change(screen.getByLabelText('Paint preset'), { target: { value: 'hard-round' } });
        expect(onPaintPresetChange).toHaveBeenCalledWith('hard-round');
