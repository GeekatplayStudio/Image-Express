        ...
        <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
                ...
                {isRenamingDesignTitle ? (
                    <input
                        ...
                        placeholder={t('editor.untitledDesign')}
                    />
                ) : (
                    <button
            ...
            <nav className="flex items-center gap-1 bg-secondary/50 p-1 rounded-lg border">
                <button
                    ...
                    title={t('editor.backToHub')}
                >
                    <HomeIcon size={16} />
                    <span>{t('editor.hub')}</span>
                </button>
                <button
                    ...
                    title={showTopNavMenus ? t('editor.collapseMenus') : t('editor.expandMenus')}
                    aria-label={t('editor.toggleTopMenuBar')}
                >
                    <ChevronRight
                        size={14}
