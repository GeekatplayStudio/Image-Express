...
export default function AICritiqueModal({
    ...
    return (
        <div
            className="fixed left-24 top-20 z-[1700] w-[24rem] max-w-[calc(100vw-2rem)] max-h-[calc(100vh-6rem)] overflow-y-auto scrollbar-thin rounded-2xl border border-border bg-card/95 text-foreground shadow-2xl backdrop-blur-xl"
        >
