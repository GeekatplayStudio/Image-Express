...
describe('/api/user/auth/google', () => {
    ...
    it('accepts the runtime-requested client ID even when env auth client ID differs', async () => {
        process.env.NEXT_PUBLIC_GOOGLE_AUTH_CLIENT_ID = 'env-client.apps.googleusercontent.com';
